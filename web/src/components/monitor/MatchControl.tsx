 ...
 *
 * **準備中のやり直しはこれ 1 つに寄せてある。** 準備フェーズではフェーズもタイマーも
 * 既に初期状態なので、指差喚呼のチェックだけを外す CLEAR（`checklist_reset`）を並べても
 * `match_reset` と結果が変わらず、**結果が同じボタンが 2 つ**並ぶ。どちらを押すべきかは
 * 画面から判断できず、片方だけ確認を挟むという食い違いも生まれる。
 */
