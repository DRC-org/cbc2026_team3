...
//
//   - **養うのは操作したチャンネルだけ。** 全チャンネルを養うと、電磁弁基板の UART へ
//     `2 1` と 1 行打った後に PC が落ちたとき、本来 500ms で全 6ch が消磁するはずの
//     ところ、**触っていない 5ch も含めて通電したまま**残る（CAN も PC も死んでいるので
//     E_STOP も届かない）。DC 基板なら同じ経路でコンベアが回り続ける
